...
\subsection{Basic camera control}
\subsubsection{Fly through mode}
...
\subsubsection{FPS exploration mode}
...
\subsection{Camera path control}

<<<<<<< HEAD
\subsection{Pictorial camera}
=======
\subsubsection{Water}
...
>>>>>>> 73653985509de8818c17cf6fbefaa28ad8cacb53
